...
export const DOCS_URL = 'https://Fluolab.cn'
...
async function fetchContributors(page = 1) {
  ...
  const data = await $fetch<{ login: string }[]>(`https://api.github.com/repos/Fluolab/Fluolab/contributors?per_page=100&page=${page}`, {
    method: 'get',
    headers: {
