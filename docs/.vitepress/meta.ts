...
// base info
export const name = 'Fluolab'
export const site = 'https://Fluolab.cn/'
export const logo = 'https://Fluolab.cn/Fluolab-logo.svg'
export const keywords = '前端专栏、学习路线、面试手册、知识体系、前端面试、前端算法、编程学习、bilibili、vitepress、随笔、资源导航、知识星球、Fluolab、React、Vue、Next.js、思维导图、coding、github'
...
export const github = 'https://github.com/Fluolab/Fluolab'
